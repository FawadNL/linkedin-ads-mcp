...
import {
  searchAdLibraryTool,
  handleSearchAdLibrary,
} from "./tools/ad-library.js";
      ...
      try {
            ...
            content: [
              {
                ...
                text: JSON.stringify({
                  ...
                  message:
                    "Please run the authentication flow first: npm run auth",
                }),
              },
            ],
            isError: true,
        ...
        switch (name) {
          ...
          case "search_ad_library":
            result = await handleSearchAdLibrary(this.apiClient, args);
            break;
